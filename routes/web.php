...
Route::get('/summit-2018/registered-users', 'FormController@show')->name('summit.result')->middleware('auth')->middleware('admin');
...
Route::get('/user/list', 'HomeController@index')->name('user.list')->middleware('auth')->middleware('superAdmin');
Route::get('/users/list','UserController@show')->middleware('auth')->middleware('superAdmin');
...
Route::get('/form/download-users', 'FormController@download')->middleware('auth')->middleware('admin');
Route::get('/form', 'HomeController@index')->name('form')->middleware('auth')->middleware('admin');
