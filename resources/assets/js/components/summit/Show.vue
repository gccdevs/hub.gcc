<template>
    <div>
        <h2>高峰會報名表單 <button class="btn btn-outline-info" @click.prevent="refresh"><em class="fa fa-refresh"> </em> 刷新</button>
        <a class="btn btn-outline-info" href="/form/download-users"><em class="fa fa-paperclip"> </em> Download</a>
        </h2>
        <br><br>
